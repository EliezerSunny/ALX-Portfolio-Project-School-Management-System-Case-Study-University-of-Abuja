                        ...
                        <div class="card h-full">
                          ...
                          <div class="card-body p-6">
                            <div class="card-text h-full">
                              ...
                              <form class="space-y-4" action="/lecturer/admin/edit_permission/{{$permissions->id}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                  @csrf
                                  @method('PUT')
                                  <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div class="input-area">
                                      ...
                                      <div class="relative">
                                        <input id="guard_name" type="text" name="guard_name" class="form-control" value="{{$permissions->guard_name}}" placeholder="Guard Name" required="required">
                                      </div>
                                    </div>
                                    ...
                                    <div class="input-area">
                                      ...
                                      <div class="relative">
                                        <input id="name" type="text" name="name" value="{{$permissions->name}}" class="form-control" placeholder="Permission" required="required">
                                      </div>
                                    </div>
