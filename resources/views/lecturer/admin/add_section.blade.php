                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="{{('/lecturer/admin/add_section')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                <div class="grid md:grid-cols-2 gap-6">
                              <div class="input-area">
                                  <label for="section" class="form-label">Academic Section:</label>
                                  <div class="relative">
                                    <input id="section" type="text" name="section" class="form-control" placeholder="Section" required="required">
                                  </div>
                                </div>
