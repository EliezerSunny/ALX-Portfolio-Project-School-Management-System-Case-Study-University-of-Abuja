@extends('layouts.admin_head')
    ...
    @section('edit_student_permission')
                    ...
                    <div class="lg:col-span-12 col-span-12">
                      <div class="card h-full">
                        <header class="card-header">
                          <h4 class="card-title">Edit "{{$student->name}}" Permission.</h4>
                        </header>

                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            
                            <form class="space-y-4" action="/lecturer/admin/update_student_permission/{{$student->id}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                @method('PUT')
                                <div class="grid md:grid-cols-2 gap-6">
                                  ...
                                  <div class="input-area">
                                    ...
                                    <option value="{{$permissions->name}}" {{-- $student->hasPermissionTo($permissions->name) ? 'selected':""--}} class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">{{$permissions->name}}</option>
                                    @endforeach
                                ...
                                bg-black" onclick="return confirm('Are you sure?')">Update permission</button>
                    ...
                    <div class="lg:col-span-12 col-span-12">
                        <div class="card h-full">
                          <header class="card-header">
                            ...
                            <form action="{{url('/lecturer/admin/search_student_p')}}" method="GET">
                              <div class="relative">
                                      ...
                                      <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700" id="data-table">
                                        ...
                                        <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                          ...
                                          <tr>
                                            ...
                                            @if ($students->getPermissionNames() === NULL)
                                          ...
                                          bg-success-500">
                                            ...
                                            <td class="table-td ">
                                              <div class="flex space-x-3 rtl:space-x-reverse">
                                                ...
                                                <a href="/lecturer/admin/edit_student_permission/{{$students->id}}">
                                                  <button class="action-btn" type="button" title="Edit">
                                                    <iconify-icon icon="heroicons:pencil-square"></iconify-icon>
                                                  </button></a>
                                                  <a href="/lecturer/admin/remove_student_permission/{{$students->id}}">
