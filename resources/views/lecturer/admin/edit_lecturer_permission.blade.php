                    ...
                    <div class="lg:col-span-12 col-span-12">
                      <div class="card h-full">
                        <header class="card-header">
                          <h4 class="card-title">Edit "{{$lecturer->name}}" Permission.</h4>
                        </header>

                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            
                            <form class="space-y-4" action="/lecturer/admin/update_lecturer_permission/{{$lecturer->id}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                @method('PUT')
                                <div class="grid md:grid-cols-2 gap-6">
                                  ...
                                  <div class="input-area">
                                    ...
                                    <option value="{{$permissions->name}}" {{-- $lecturer->hasPermissionTo($permissions->name) ? 'selected':""--}} class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">{{$permissions->name}}</option>
                                    @endforeach
