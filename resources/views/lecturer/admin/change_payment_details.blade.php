@extends('layouts.admin_head')
    ...
    @section('change_payment_details')
                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="/lecturer/admin/change_payment_details/{{$payments->id}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                @method('PUT')
                                <div class="grid md:grid-cols-2 gap-6">
                                    <div class="input-area">
                                        ...
                                        <div class="relative">
                                            <input id="currency" type="text" name="currency" class="form-control" value="{{$payments->currency}}" placeholder="Amount" required="required">
                                          </div>
                                      </div>
                                      ...
                                      <div class="input-area">
                                        ...
                                        <div class="relative">
                                          <input id="amount" type="tel" name="amount" class="form-control" value="{{$payments->amount}}" placeholder="Amount" required="required">
                                        </div>
                                      </div>
                                      ...
                                      <div class="input-area">
                                        ...
                                        <div class="relative">
                                          <input id="payment_name" type="text" name="payment_name" class="form-control" value="{{$payments->payment_name}}" placeholder="Payment Name" required="required">
                                        </div>
                                      </div>
      
                                      <div class="input-area">
                                          <label for="faculty_id" class="form-label">Faculty: <i>{{$payments->faculty->faculty_name}}</i></label>
                                        ...
                                        <div class="input-area">
                                          <label for="department_id" class="form-label">Department: <i>{{$payments->department->department_name}}</i></label>
                                        ...
                                        <div class="input-area">
                                          <label for="level_id" class="form-label">Level: <i>{{$payments->level->level}}</i></label>
