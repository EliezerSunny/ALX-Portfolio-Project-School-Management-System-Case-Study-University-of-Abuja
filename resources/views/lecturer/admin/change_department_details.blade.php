@extends('layouts.admin_head')
    ...
    @section('change_department_details')
                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="/lecturer/admin/change_department_details/{{$departments->id}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                @method('PUT')
                                <div class="grid md:grid-cols-2 gap-6">

                                  <div class="input-area">
                                    <label for="faculty_id" class="form-label">Faculty: <i>{{$departments->faculty->faculty_name}}</i></label>
                                   <div class="relative">
                                            <input id="faculty_id" type="text" name="faculty_id" value="{{$departments->faculty_id}}" class="form-control" placeholder="Faculty" required="required">
                                          </div>
                                  </div>
                              ...
                              <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="department_name" type="text" name="department_name" value="{{$departments->department_name}}" class="form-control" placeholder="Department" required="required">
                                  </div>
                                </div>
                                ...
                                <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="department_abbreviation" type="text" name="department_abbreviation" value="{{$departments->department_abbreviation}}" class="form-control" placeholder="Department Abbreviation" required="required">
                                  </div>
                                </div>
                                  ...
                                  <div class="input-area">
                                    ...
                                    <div class="relative">
                                      <input id="department_hod_name" type="text" name="department_hod_name" value="{{$departments->department_hod_name}}" class="form-control" placeholder="HOD Name" required="required">
                                    </div>
                                  </div>
