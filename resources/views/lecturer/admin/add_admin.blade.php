                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="{{('/lecturer/admin/add_admin')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                              ...
                              <div class="input-area">
                                ...
                                <div class="input-area">
                                    ...
                                    <div class="relative">
                                      <input id="position" type="text" name="position" class="form-control" placeholder="Position" required="required">
                                    </div>
                                  </div>
