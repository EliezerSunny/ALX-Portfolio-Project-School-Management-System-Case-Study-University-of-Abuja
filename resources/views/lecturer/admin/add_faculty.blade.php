                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="{{('/lecturer/admin/add_faculty')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                <div class="grid md:grid-cols-2 gap-6">
                              <div class="input-area">
                                  <label for="faculty_name" class="form-label">Faculty:</label>
                                  <div class="relative">
                                    <input id="faculty" type="text" name="faculty_name" class="form-control" placeholder="Faculty" required="required">
                                  </div>
                                </div>
                                ...
                                <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="faculty_award" type="text" name="faculty_award" class="form-control" placeholder="Faculty Award" required="required">
                                  </div>
                                </div>
                                  ...
                                  <div class="input-area">
                                    ...
                                    <div class="relative">
                                      <input id="dean_name" type="text" name="faculty_dean_name" class="form-control" placeholder="Dean Name" required="required">
                                    </div>
                                  </div>
