                        ...
                        <div class="card h-full">
                          ...
                          <div class="card-body p-6">
                            <div class="card-text h-full">
                              ...
                              <form class="space-y-4" action="{{route('lecturer.admin.post_admin_role_permission')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                  @csrf
                                  <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div class="input-area">
                                      ...
                                      {{-- <div class="input-area">
                                        ...
                                        <select name="admin_id" id="admin_id" class="form-control w-full mt-2">
                                        <option selected="Selected" disabled="disabled" value="none" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">Select an option</option>
                                        
                                        @foreach ($admins as $admin)
                                        <option value="{{$admin->id}}" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">{{$admin->name}}</option>
                                        @endforeach
