                    ...
                    <div class="lg:col-span-12 col-span-12">
                      <div class="card h-full">
                        <header class="card-header">
                          <h4 class="card-title">Add Countdown</h4>
                        </header>

                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            
                            <form class="space-y-4" action="{{('/lecturer/admin/upload_countdown')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                              @csrf
                                <div class="grid md:grid-cols-2 gap-6">
                              <div class="input-area">
                                  <label for="coursereg_timer" class="form-label">Countdown:</label>
                                  <div class="relative">
                                    <input id="coursereg_timer" type="text" name="coursereg_timer" value="{{'December 31, 2023 23:59:59'}}" class="form-control" placeholder="Countdown" required="required">
                                  </div>
                                </div>
                                        ...
                                        <tr>
                                          ...
                                          <td class="table-td ">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                              <a href="/lecturer/admin/edit_countdown/{{$countdowns->id}}">
