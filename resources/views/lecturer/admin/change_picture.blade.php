                      ...
                      <div class="lg:col-span-7 col-span-12">
                        <div class="card h-full">
                          <header class="card-header">
                            ...
                            <a href="{{url('/lecturer/admin/settings_a')}}">
                          ...
                          <div class="card-body p-6">
                            <div class="card-text h-full">
                              ...
                              <form class="space-y-4" action="{{('/lecturer/admin/change_picture')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                @method('Put')  
                                <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div class="input-area">
                                        ...
                                        <div class="relative">
                                          <input id="name" type="text" name="name" value="{{Auth::guard('admin')->user()->name}}" readonly class="form-control" placeholder="Name" required="required">
                                        </div>
                                      </div>
