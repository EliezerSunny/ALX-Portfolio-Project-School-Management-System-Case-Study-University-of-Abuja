                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="{{('/lecturer/admin/add_course')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                <div class="grid md:grid-cols-2 gap-6">
                              <div class="input-area">
                                  <label for="course_code" class="form-label">Course code:</label>
                                  <div class="relative">
                                    <input id="course_code" type="text" name="course_code" class="form-control" placeholder="Course code" required="required">
                                  </div>
                                </div>
                                ...
                                <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="course_title" type="text" name="course_title" class="form-control" placeholder="Course title" required="required">
                                  </div>
                                </div>
                                ...
                                <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="course_unit" type="text" name="course_unit" class="form-control" placeholder="Course unit" required="required">
                                  </div>
                                </div>
                                ...
                                <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="course_status" type="text" name="course_status" class="form-control" placeholder="Course status" required="required">
                                  </div>
                                </div>
