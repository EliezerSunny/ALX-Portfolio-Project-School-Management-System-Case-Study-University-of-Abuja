                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="/lecturer/admin/change_level_details/{{$levels->id}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                @method('PUT')
                              ...
                              <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="level" type="text" name="level" class="form-control" value="{{$levels->level}}" placeholder="Level" required="required">
                                  </div>
                                </div>
