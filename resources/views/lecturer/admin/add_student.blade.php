                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="{{('/lecturer/admin/add_student')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                              ...
                              <div class="input-area">
                                ...
                                <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="school_email" type="email" name="school_email" class="form-control" placeholder="School Email" required="required">
                                  </div>
                                </div>
                                ...
                                {{-- <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="position" type="text" name="position" class="form-control" value="Student" placeholder="Position" readonly required="required">
                                  </div>
                                </div> --}}

                                {{-- <div class="input-area">
                                    <label for="reg_id" class="form-label">Registration No.:</label>
                                    <div class="relative">
                                      <input id="reg_id" type="text" name="reg_id" class="form-control" placeholder="Registration No. / Matric No." required="required">
                                    </div>
                                  </div> --}}
                                  ...
                                  <div class="input-area">
                                    ...
                                    <select name="department_abbreviation" id="department_abbreviation" class="form-control w-full mt-2">
                                      <option selected="Selected" disabled="disabled" value="none" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">Select an option</option>
                                      
                                      @foreach ($department as $departments)
                                      <option value="{{$departments->department_abbreviation}}" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">{{$departments->department_abbreviation}}</option>
                                      @endforeach
                                  ...
                                  {{-- <div class="input-area">
                                    ...
                                    <select name="programme_id" id="programme_id" class="form-control w-full mt-2">
                                      <option selected="Selected" disabled="disabled" value="none" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">Select an option</option>
                                      
                                      @foreach ($department as $departments)
                                      <option value="{{$departments->id}}" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">{{$departments->programme}}</option>
                                      @endforeach
                                  ...
                                  {{-- <div class="input-area">
                                    ...
                                    <div class="relative">
                                      <input id="picture" type="file" name="picture" class="form-control" placeholder="Picture" required="required">
                                    </div>
                                  </div> --}}
                                ...
                                bg-black" title="Add" onclick="return confirm('Are you sure you want to add student?')">Submit</button>
                    ...
                    <div class="lg:col-span-12 col-span-12">
                      <div class="card h-full">
                        <header class="card-header">
                          ...
                          <form action="{{url('/lecturer/admin/search_student')}}" method="GET">
                            <div class="relative">
                              <input id="search_student" type="text" name="q" class="form-control" placeholder="Search..." required="required">
