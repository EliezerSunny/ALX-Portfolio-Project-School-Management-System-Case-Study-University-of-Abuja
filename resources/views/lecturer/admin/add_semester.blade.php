                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="{{('/lecturer/admin/add_semester')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                              ...
                              <div class="input-area">
                                  ...
                                  <div class="relative">
                                    <input id="semester" type="text" name="semester" class="form-control" placeholder="Semester" required="required">
                                  </div>
                                </div>
                                        ...
                                        <tr>
                                          ...
                                          <td class="table-td ">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                              ...
                                              <a href="/lecturer/admin/change_semester_details/{{$semesters->id}}">
                                              <button class="action-btn" type="button">
