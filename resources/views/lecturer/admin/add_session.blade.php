                      ...
                      <div class="card h-full">
                        ...
                        <div class="card-body p-6">
                          <div class="card-text h-full">
                            ...
                            <form class="space-y-4" action="{{('/lecturer/admin/add_session')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf
                                <div class="grid md:grid-cols-2 gap-6">
                              <div class="input-area">
                                  <label for="session" class="form-label">Academic Session:</label>
                                  <div class="relative">
                                    <input id="session" type="text" name="session" class="form-control" placeholder="Session" required="required">
                                  </div>
                                </div>
