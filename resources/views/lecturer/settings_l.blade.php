                        ...
                        <div class="card h-full">
                          ...
                          <div class="card-body p-6">
                            <div class="card-text h-full">
                              ...
                              <form class="space-y-4" action="{{url('/lecturer/settings_l')}}" method="POST" enctype="multipart/form-data" id="multipleValidation">
                                @csrf  
                                @method('PUT')
                                  <div class="grid md:grid-cols-7 gap-6">
                                    <div class="input-area">
                                        ...
                                        <div class="relative">
                                          <input id="email" type="email" name="email" class="form-control" placeholder="Change Email" value="{{Auth::guard('lecturer')->user()->email}}" required="required">
                                        </div>
                                      </div>
                                      ...
                                      <div class="input-area">
                                        ...
                                        <div class="relative">
                                          <input id="school_email" type="email" name="school_email" class="form-control" placeholder="Change School Email" value="{{Auth::guard('lecturer')->user()->school_email}}" required="required">
                                        </div>
                                      </div>
